...
[assembly: EdmRelationshipAttribute("CURSOModel", "FK_TB_DESENVOLVEDOR_TB_STATUS", "TB_STATUS", System.Data.Metadata.Edm.RelationshipMultiplicity.One, typeof(CURSOModel.TB_STATUS), "TB_DESENVOLVEDOR", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, typeof(CURSOModel.TB_DESENVOLVEDOR), true)]
...
namespace CURSOModel
{
    ...
    public partial class TB_DESENVOLVEDOR : EntityObject
    {
        ...
        public static TB_DESENVOLVEDOR CreateTB_DESENVOLVEDOR(global::System.Int32 iD_DESENVOLVEDOR, global::System.String nM_DESENVOLVEDOR, global::System.Int32 iD_STATUS)
        {
            ...
            tB_DESENVOLVEDOR.ID_STATUS = iD_STATUS;
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("CURSOModel", "FK_TB_DESENVOLVEDOR_TB_STATUS", "TB_STATUS")]
        public TB_STATUS TB_STATUS
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<TB_STATUS>("CURSOModel.FK_TB_DESENVOLVEDOR_TB_STATUS", "TB_STATUS").Value;
            }
            set
            {
                ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<TB_STATUS>("CURSOModel.FK_TB_DESENVOLVEDOR_TB_STATUS", "TB_STATUS").Value = value;
            }
        }
        /// <summary>
        /// No Metadata Documentation available.
        ...
        public EntityReference<TB_STATUS> TB_STATUSReference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<TB_STATUS>("CURSOModel.FK_TB_DESENVOLVEDOR_TB_STATUS", "TB_STATUS");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<TB_STATUS>("CURSOModel.FK_TB_DESENVOLVEDOR_TB_STATUS", "TB_STATUS", value);
                }
            }
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="CURSOModel", Name="TB_STATUS")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class TB_STATUS : EntityObject
    {
        ...
        public global::System.String NM_STATUS
        {
            ...
            set
            {
                ...
                _NM_STATUS = StructuralObject.SetValidValue(value, false);
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("CURSOModel", "FK_TB_DESENVOLVEDOR_TB_STATUS", "TB_DESENVOLVEDOR")]
        public EntityCollection<TB_DESENVOLVEDOR> TB_DESENVOLVEDOR
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<TB_DESENVOLVEDOR>("CURSOModel.FK_TB_DESENVOLVEDOR_TB_STATUS", "TB_DESENVOLVEDOR");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<TB_DESENVOLVEDOR>("CURSOModel.FK_TB_DESENVOLVEDOR_TB_STATUS", "TB_DESENVOLVEDOR", value);
                }
            }
        }
